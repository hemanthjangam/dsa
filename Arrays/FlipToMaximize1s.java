...
// Formally, select a range (l, r) in the array arr[], such that (0 ≤ l ≤ r < n) holds and
...
//Input: arr[] = [1, 0, 0, 1, 0]
//Output: 4
//Explanation: By flipping the subarray from index 1 to 2,
// the array becomes [1, 1, 1, 1, 0].
// This results in a total of 4 ones,
// which is the maximum possible after at most one flip.

//Input: arr[] = [1, 0, 0, 1, 0, 0, 1]
//Output: 6
//Explanation: By flipping the subarray from index 1 to 5,
// the array becomes [1, 1, 1, 0, 1, 1, 1].
// This results in a total of 6 ones,
// which is the maximum possible after at most one flip.

public class FlipToMaximize1s {
    static int maximize(int[] nums) {
        int max = 0, curr = 0;
